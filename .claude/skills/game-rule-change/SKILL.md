...
description: >
  Change scoring, comparison, straights, stand rules, ties/sub-rounds, or chip
  flows in the dice game. Use when a task alters game rules rather than
  plumbing — e.g. payout amounts, what beats what, when standing is legal.
---
